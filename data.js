window.PORTFOLIO_PROJECTS = [
  {
    ...
    "decisions": [
      ...
      [
        "테스트에서 실제 사용까지",
        "Flutter integration_test로 저장소·PIN 호환성 검증을 구성하고, Android ADB 기반 E2E와 iOS XCTest/XCUITest로 QR·딥링크·권한 복구·설정 보존 등 사용자 흐름을 검증했습니다."
      ],
      [
        "SDK 재초기화 후 대기 상태 복구",
    ...
    "outcome": "AI를 활용한 개발을 재현 테스트와 실기기 검증으로 연결해, 기능 구현 이후의 복구 동작과 회귀 방지까지 점검했습니다. 2026.08 집계에서 테스트 파일을 1개에서 175개로 확대했으며, 이 중 171개를 본인 커밋으로 추가했습니다."
  },
  {
    "id": "mindhill",
    "name": "Mindhill",
